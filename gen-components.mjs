...
const collections = [
  {
    ...
    designs: [
      { name: 'Velli Border', slug: 'velli-border', desc: 'Silver contrast border silk with lustrous zari', img: '/4-pose2.png', badge: 'Popular', badgeIcon: 'fa-star' },
      { name: 'Kolam Pattu', slug: 'kolam-pattu', desc: 'Geometric kolam woven saree with festive zari', img: '/sec-pose4.png' },
      { name: 'Venkai Kodi', slug: 'venkai-kodi', desc: 'Flame blossom silk with warm gold borders', img: '/image9.png', badge: 'New', badgeIcon: 'fa-sparkles' },
    ],
    ...
    heroImgs: ['/4-pose3.png', '/4-pose2.png', '/sec-pose4.png', '/image9.png', '/sec-pose5.png'],
    mobileImg: '/4-pose2.png', mobileImg2: '/sec-pose4.png', mobileImg3: '/image9.png',
  ...
  },
  {
    ...
    designs: [
      { name: 'Azhagu Pattu', slug: 'azhagu-pattu', desc: 'Beautiful woven festive silk with refined elegance', img: '/w4.png', badge: 'Bestseller', badgeIcon: 'fa-crown' },
      { name: 'Kaanchi Ezhil', slug: 'kaanchi-ezhil', desc: 'Heritage silk with classic Kanchipuram-inspired weave', img: '/3-pose2.png' },
    ...
    heroImgs: ['/w5.png', '/w4.png', '/3-pose2.png', '/image11.png', '/3-pose4.png'],
    mobileImg: '/w4.png', mobileImg2: '/3-pose2.png', mobileImg3: '/image11.png',
  ...
  },
  {
    ...
    designs: [
      { name: 'Poigai Pattu', slug: 'poigai-pattu', desc: 'Water lily motif woven silk for elegant occasions', img: '/w2.png', badge: 'Popular', badgeIcon: 'fa-star' },
    ...
    heroImgs: ['/w3.png', '/w2.png', '/3-pose3.png', '/sec-pose5.png', '/w4.png'],
    mobileImg: '/w2.png', mobileImg2: '/3-pose3.png', mobileImg3: '/sec-pose5.png',
  ...
  },
  {
    ...
    designs: [
      { name: 'Sudar Pattu', slug: 'sudar-pattu', desc: 'Radiant sun motif woven silk for grand celebrations', img: '/red-pose3.png', badge: 'Popular', badgeIcon: 'fa-sun' },
      { name: 'Niram Pattu', slug: 'niram-pattu', desc: 'Vivid color spectrum silk with rich gold borders', img: '/viol.png' },
    ...
    heroImgs: ['/red-pose2.png', '/red-pose3.png', '/viol.png', '/4-pose4.png', '/4-pose1.png'],
    mobileImg: '/red-pose3.png', mobileImg2: '/viol.png', mobileImg3: '/4-pose4.png',
  ...
  },
  {
    ...
    designs: [
      { name: 'Amudha Pattu', slug: 'amudha-pattu', desc: 'Nectar motif woven silk for festive gifting', img: '/image10.png', badge: 'Gifting', badgeIcon: 'fa-gift' },
    ...
    heroImgs: ['/4-pose2.png', '/image10.png', '/4-pose3.png', '/sec-pose1.png', '/sec-pose5.png'],
    mobileImg: '/image10.png', mobileImg2: '/4-pose3.png', mobileImg3: '/sec-pose1.png',
