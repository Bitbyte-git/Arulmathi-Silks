...
import { getMayuraPattuCollection } from '../data/mayuraPattuProducts'

export default function MayuraCollectionPage({ collectionSlug }) {
    ...
    return (
      <section className="bg-[#f6efe4] px-5 py-32 text-[#1a1420] sm:px-8 lg:px-16">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <a href="/mayura-pattu" className="mt-8 inline-flex items-center gap-3 rounded bg-[#b57922] px-5 py-3 font-sans text-[11px] font-bold uppercase tracking-[1.8px] text-white">
            Back to Mayura Pattu <i className="fas fa-arrow-right" />
          </a>
        </div>
      </section>
    )
    ...
    <section className="bg-[#f6efe4] text-[#1a1420]">
      ...
      <div className="relative isolate overflow-hidden bg-[#080711] px-5 pb-16 pt-10 text-white sm:px-8 lg:px-16">
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 lg:grid-cols-[0.48fr_0.52fr] lg:items-center">
          <div>
            <a href="/mayura-pattu" className="inline-flex border-b border-[#c9933a] pb-1 font-sans text-[10px] font-bold uppercase tracking-[2.5px] text-[#c9933a] transition-colors hover:text-[#f0c36e]">
              <i className="fas fa-arrow-left mr-2" /> Mayura Pattu
            </a>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {collection.designs.map((design, index) => (
              ...
              >
                  <a href={`/mayura-pattu/${collection.slug}/${design.slug}`} aria-label={`View ${design.name} details`} className="premium-saree-media group relative block h-[290px] overflow-hidden bg-[#e8ddcf]">
                  <img
                    src={design.image}
                    alt={design.name}
                    loading="lazy"
                ...
                <div className="p-5">
                  ...
                  <a
                    href={`/mayura-pattu/${collection.slug}/${design.slug}`}
