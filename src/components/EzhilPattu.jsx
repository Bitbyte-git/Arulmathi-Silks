const ezhilDesigns = [
  { name: 'Thanga Thorana Pattu', slug: 'azhagu-pattu', href: '/ezhil-pattu/azhagu-pattu', desc: 'Beautiful woven festive silk with refined elegance', img: '/Ezhil-pattu/EZ-TT-0101-1.png', badge: 'Bestseller', badgeIcon: 'fa-crown' },
]
          ...
          <div className="relative">
            <div className="hidden h-[620px] translate-x-[20px] grid-cols-12 grid-rows-10 gap-3 lg:grid xl:h-[700px]">
              ...
              <div className="hero-box-image hero-frame-gold col-start-4 col-end-9 row-start-1 row-end-5 overflow-hidden rounded-sm bg-[#eadfce] p-2 shadow-[0_24px_66px_rgba(0,0,0,0.46)]" style={{ '--frame-delay': '0ms' }}>
                <img src="/Ezhil-pattu/EZ-TT-0101-1.png" alt="Ezhil Pattu main" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.92]" />
              </div>
            ...
            <div className="grid gap-4 lg:hidden">
              <div className="hero-box-image overflow-hidden rounded-lg border border-[#c9933a]/34 bg-[#0d0d1a] shadow-[0_26px_70px_rgba(0,0,0,0.42)]">
                <img src="/Ezhil-pattu/EZ-TT-0101-1.png" alt="Ezhil Pattu" className="h-[440px] w-full object-cover object-top brightness-[0.88]" />
              </div>
