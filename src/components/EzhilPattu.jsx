const ezhilDesigns = [
  { name: 'Azhagu Pattu', slug: 'azhagu-pattu', href: '/ezhil-pattu/azhagu-pattu', desc: 'Beautiful woven festive silk with refined elegance', img: '/w4.png', badge: 'Bestseller', badgeIcon: 'fa-crown' },
  { name: 'Kaanchi Ezhil', slug: 'kaanchi-ezhil', href: '/ezhil-pattu/kaanchi-ezhil', desc: 'Heritage silk with classic Kanchipuram-inspired weave', img: '/3-pose2.png' },
  { name: 'Parisil Pattu', slug: 'parisil-pattu', href: '/ezhil-pattu/parisil-pattu', desc: 'Elegant gifting saree with soft borders and drape', img: '/image11.png', badge: 'Gifting', badgeIcon: 'fa-gift' },
]
          ...
          <div className="relative">
            <div className="hidden h-[620px] translate-x-[20px] grid-cols-12 grid-rows-10 gap-3 lg:grid xl:h-[700px]">
              ...
              <div className="hero-box-image hero-frame-gold col-start-4 col-end-9 row-start-1 row-end-5 overflow-hidden rounded-sm bg-[#eadfce] p-2 shadow-[0_24px_66px_rgba(0,0,0,0.46)]" style={{ '--frame-delay': '0ms' }}>
                <img src="/w4.png" alt="Ezhil Pattu main" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.92]" />
              </div>
              <div className="hero-box-image hero-frame-gold col-start-9 col-end-12 row-start-1 row-end-3 overflow-hidden rounded-sm bg-[#eadfce] p-1.5 shadow-[0_16px_38px_rgba(0,0,0,0.34)]" style={{ '--frame-delay': '160ms' }}>
                <img src="/3-pose2.png" alt="Ezhil Pattu detail" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.9]" />
              </div>
            ...
            <div className="grid gap-4 lg:hidden">
              <div className="hero-box-image overflow-hidden rounded-lg border border-[#c9933a]/34 bg-[#0d0d1a] shadow-[0_26px_70px_rgba(0,0,0,0.42)]">
                <img src="/w4.png" alt="Ezhil Pattu" className="h-[440px] w-full object-cover object-top brightness-[0.88]" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="overflow-hidden rounded-lg border border-[#c9933a]/24 bg-[#0d0d1a]">
                  <img src="/3-pose2.png" alt="Ezhil Pattu detail" className="h-[180px] w-full object-cover object-top brightness-[0.84]" />
                </div>
                <div className="overflow-hidden rounded-lg border border-[#c9933a]/24 bg-[#0d0d1a]">
