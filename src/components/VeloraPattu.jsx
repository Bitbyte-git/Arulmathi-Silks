...
const veloraDesigns = [
  { name: 'Velli Malar Pattu', slug: 'velli-border', href: '/velora-pattu/velli-border', desc: 'Silver contrast border silk with lustrous zari', img: veloraPattuCollections[0].cardImage, badge: 'Popular', badgeIcon: 'fa-star' },
]
...
export default function VeloraPattu() {
  return (
    <section id="velora-pattu" className="section-reveal bg-[#13121f]">
      <style>
        {`
          #velora-pattu .velora-design-card:hover .velora-design-image {
            transform: scale(1.05);
          }

          #velora-pattu .velora-design-title {
          ...
          #velora-pattu .velora-design-desc {
          ...
          #velora-pattu .velora-design-body {
              ...
              {veloraDesigns.map((saree) => (
                <article key={saree.name} className="velora-design-card relative flex w-[82vw] max-w-[380px] flex-col overflow-hidden rounded-xl border border-[#e4cba8] bg-[#fffaf2] text-[#1a1a2e] shadow-[0_14px_34px_rgba(92,58,24,0.14)] transition-all duration-300 hover:-translate-y-1 hover:border-[#c9933a]/70 hover:shadow-[0_24px_52px_rgba(92,58,24,0.20)] sm:w-[300px] lg:w-[330px] xl:w-[350px]">
                  ...
                  <a href={saree.href} className="block h-[230px] shrink-0 overflow-hidden bg-[#e8ddcf] sm:h-[250px] lg:h-[270px]" aria-label={`Open ${saree.name} designs`}>
                    <img src={saree.img} alt={saree.name} className="velora-design-image h-full w-full object-cover object-top transition-transform duration-500" />
                  </a>
                  <div className="velora-design-body flex flex-1 flex-col rounded-t-lg bg-[#fffaf2] px-5 pb-6 pt-6 text-center shadow-[0_-10px_22px_rgba(74,45,18,0.08)]">
                    <h3 className="velora-design-title font-sans text-[19px] font-extrabold leading-tight text-[#241b27]">{saree.name}</h3>
                    <p className="velora-design-desc mx-auto mt-3 min-h-[48px] max-w-[290px] font-sans text-[15px] font-semibold leading-[1.5] text-[#4a3f49]">{saree.desc}</p>
