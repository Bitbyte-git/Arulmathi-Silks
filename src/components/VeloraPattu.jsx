const veloraDesigns = [
  { name: 'Velli Malar Pattu', slug: 'velli-border', href: '/velora-pattu/velli-border', desc: 'Silver contrast border silk with lustrous zari', img: '/Velora-pattu/VP-VM-5.png', badge: 'Popular', badgeIcon: 'fa-star' },
]
