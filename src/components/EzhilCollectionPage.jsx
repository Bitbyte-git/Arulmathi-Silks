...
import { getEzhilPattuCollection } from '../data/ezhilPattuProducts'

export default function EzhilCollectionPage({ collectionSlug }) {
    ...
    <section className="bg-[#f6efe4] text-[#1a1420]">
      ...
      <div className="relative isolate overflow-hidden bg-[#080711] px-5 pb-16 pt-10 text-white sm:px-8 lg:px-16">
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 lg:grid-cols-[0.48fr_0.52fr] lg:items-center">
          <div>
            <a href="/ezhil-pattu" className="inline-flex border-b border-[#c9933a] pb-1 font-sans text-[10px] font-bold uppercase tracking-[2.5px] text-[#c9933a] transition-colors hover:text-[#f0c36e]">
              <i className="fas fa-arrow-left mr-2" /> Ezhil Pattu
            </a>
            ...
            {collection.designs.map((design, index) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <a
                    href={`/ezhil-pattu/${collection.slug}/${design.slug}`}
