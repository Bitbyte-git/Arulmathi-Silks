...
import { getVarnikaPattuCollection, getVarnikaPattuDesign } from '../data/varnikaPattuProducts'
...
export default function VarnikaDesignDetail({ collectionSlug, designSlug }) {
  const collection = getVarnikaPattuCollection(collectionSlug)
  const design = getVarnikaPattuDesign(collectionSlug, designSlug)
    ...
    <section className="bg-[#080711] text-white">
      <div className="relative isolate overflow-hidden px-5 pb-12 pt-10 sm:px-8 lg:px-16">
        ...
        <div className="mx-auto max-w-7xl">
          <a href={`/varnika-pattu/${collection.slug}`} className="inline-flex border-b border-[#c9933a] pb-1 font-sans text-[10px] font-bold uppercase tracking-[2.5px] text-[#c9933a] transition-colors hover:text-[#f0c36e]">
