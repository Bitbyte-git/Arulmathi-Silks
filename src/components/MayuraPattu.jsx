const mayuraDesigns = [
  { name: 'Mayil Peru', slug: 'mayil-peru', href: '/mayura-pattu/mayil-peru', desc: 'Peacock feather woven silk for grand occasions', img: '/4-pose1.png', badge: 'Bestseller', badgeIcon: 'fa-crown' },
  { name: 'Thogai Border', slug: 'thogai-border', href: '/mayura-pattu/thogai-border', desc: 'Fan-shaped peacock border design', img: '/4-pose3.png', badge: 'New', badgeIcon: 'fa-sparkles' },
  { name: 'Kaadai Kodi', slug: 'kaadai-kodi', href: '/mayura-pattu/kaadai-kodi', desc: 'Wild peacock vine motif woven silk', img: '/w5.png' },
]

const mayuraNotes = [
  'Peacock-inspired motifs — feathers, fans, and vine patterns woven into premium silk',
  'Vivid festive colors with gold zari borders and contrast pallus',
  'Curated for receptions, engagements, and grand family celebrations',
]
...
export default function MayuraPattu() {
  return (
    <section id="mayura-pattu" className="section-reveal bg-[#13121f]">
        ...
        <div className="relative mx-auto grid max-w-[1540px] grid-cols-1 gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:items-center lg:gap-12 xl:gap-16">
          <div className="max-w-[560px] lg:pb-6">
            ...
            <p className="mt-6 max-w-[520px] font-sans text-[13px] leading-[1.95] text-white/76 sm:text-[14px]">
              Peacock-inspired silk sarees with feather motifs, fan borders, and vivid festive colors for the grandest celebrations.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <a href="/#shop" className="glow-cta inline-flex items-center gap-3 border border-[#c9933a]/80 px-5 py-3 font-sans text-[11px] font-semibold uppercase tracking-[1.9px] text-[#d9a046] transition-colors hover:bg-[#c9933a] hover:text-[#13121f]">Shop Mayura Pattu <i className="fas fa-arrow-right" /></a>
          ...
          <div className="relative">
            <div className="hidden h-[620px] translate-x-[20px] grid-cols-12 grid-rows-10 gap-3 lg:grid xl:h-[700px]">
              <div className="hero-box-image hero-frame-gold col-start-1 col-end-4 row-start-3 row-end-6 overflow-hidden rounded-sm bg-[#eadfce] p-1.5 shadow-[0_18px_42px_rgba(0,0,0,0.36)]" style={{ '--frame-delay': '80ms' }}><img src="/4-pose2.png" alt="Mayura Pattu peacock silk" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.9]" /></div>
              <div className="hero-box-image hero-frame-gold col-start-4 col-end-9 row-start-1 row-end-5 overflow-hidden rounded-sm bg-[#eadfce] p-2 shadow-[0_24px_66px_rgba(0,0,0,0.46)]" style={{ '--frame-delay': '0ms' }}><img src="/4-pose1.png" alt="Mayura Pattu mayil peru" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.92]" /></div>
              <div className="hero-box-image hero-frame-gold col-start-9 col-end-12 row-start-1 row-end-3 overflow-hidden rounded-sm bg-[#eadfce] p-1.5 shadow-[0_16px_38px_rgba(0,0,0,0.34)]" style={{ '--frame-delay': '160ms' }}><img src="/w4.png" alt="Mayura feather detail" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.9]" /></div>
              <div className="hero-box-image hero-frame-gold col-start-2 col-end-7 row-start-5 row-end-10 overflow-hidden rounded-sm bg-[#eadfce] p-2 shadow-[0_24px_62px_rgba(0,0,0,0.44)]" style={{ '--frame-delay': '240ms' }}><img src="/4-pose3.png" alt="Mayura thogai border" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.9]" /></div>
              <div className="hero-box-image hero-frame-gold col-start-7 col-end-10 row-start-5 row-end-8 overflow-hidden rounded-sm bg-[#eadfce] p-1.5 shadow-[0_16px_38px_rgba(0,0,0,0.34)]" style={{ '--frame-delay': '320ms' }}><img src="/w2.png" alt="Mayura kaadai kodi" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.9]" /></div>
            </div>
            <div className="grid gap-4 lg:hidden">
              <div className="hero-box-image overflow-hidden rounded-lg border border-[#c9933a]/34 bg-[#0d0d1a] shadow-[0_26px_70px_rgba(0,0,0,0.42)]"><img src="/4-pose1.png" alt="Mayura Pattu silk" className="h-[440px] w-full object-cover object-top brightness-[0.88]" /></div>
              <div className="grid grid-cols-2 gap-4">
                <div className="overflow-hidden rounded-lg border border-[#c9933a]/24 bg-[#0d0d1a]"><img src="/4-pose3.png" alt="Mayura fan border" className="h-[180px] w-full object-cover object-top brightness-[0.84]" /></div>
                <div className="overflow-hidden rounded-lg border border-[#c9933a]/24 bg-[#0d0d1a]"><img src="/w5.png" alt="Mayura vine silk" className="h-[180px] w-full object-cover object-top brightness-[0.88]" /></div>
              </div>
              <div className="hero-box-info rounded-lg border border-[#c9933a]/28 bg-[#1b1930]/78 p-5 shadow-[0_14px_34px_rgba(0,0,0,0.22)] backdrop-blur-sm">
                <p className="font-sans text-[10px] font-semibold uppercase tracking-[2.4px] text-[#c9933a]">Mayura Notes</p>
                <ul className="mt-4 space-y-3">
                  {mayuraNotes.map((item, index) => (
