const kaithiraiDesigns = [
  { name: 'Poigai Pattu', slug: 'poigai-pattu', href: '/kaithirai-pattu/poigai-pattu', desc: 'Water lily motif woven silk for elegant occasions', img: '/Kathirai-pattu/KP-PP-2.png', badge: 'Popular', badgeIcon: 'fa-star' },
]

const kaithiraiNotes = [
  'Nature-inspired motifs — lotus, bay leaf vine, and palm weave patterns',
  'Antique gold zari borders for festive and gifting occasions',
  'Curated for poojas, family functions, and refined celebrations',
]
...
export default function KaithiraiPattu() {
  return (
    <section id="kaithirai-pattu" className="section-reveal bg-[#13121f]">
      <style>
        {`
          #kaithirai-pattu .kaithirai-design-card:hover .kaithirai-design-image {
            transform: scale(1.05);
          }

          #kaithirai-pattu .kaithirai-design-title {
          ...
          #kaithirai-pattu .kaithirai-design-desc {
          ...
          #kaithirai-pattu .kaithirai-design-body {
        ...
        <div className="relative mx-auto grid max-w-[1540px] grid-cols-1 gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:items-center lg:gap-12 xl:gap-16">
          <div className="max-w-[560px] lg:pb-6">
            ...
            <p className="mt-6 max-w-[520px] font-sans text-[13px] leading-[1.95] text-white/76 sm:text-[14px]">
              Nature-inspired silk sarees with water lily, bay leaf vine, and palm weave motifs — deeply loved across Salem for festive and gifting occasions.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <a href="/#shop" className="glow-cta inline-flex items-center gap-3 border border-[#c9933a]/80 px-5 py-3 font-sans text-[11px] font-semibold uppercase tracking-[1.9px] text-[#d9a046] transition-colors hover:bg-[#c9933a] hover:text-[#13121f]">
                Shop Kaithirai Pattu <i className="fas fa-arrow-right" />
              </a>
          ...
          <div className="relative">
            <div className="hidden h-[620px] translate-x-[20px] grid-cols-12 grid-rows-10 gap-3 lg:grid xl:h-[700px]">
              <div className="hero-box-image hero-frame-gold col-start-1 col-end-4 row-start-3 row-end-6 overflow-hidden rounded-sm bg-[#eadfce] p-1.5 shadow-[0_18px_42px_rgba(0,0,0,0.36)]" style={{ '--frame-delay': '80ms' }}>
                <img src="/Kathirai-pattu/KP-PP-1.png" alt="Kaithirai Pattu silk" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.9]" />
              </div>
              <div className="hero-box-image hero-frame-gold col-start-4 col-end-9 row-start-1 row-end-5 overflow-hidden rounded-sm bg-[#eadfce] p-2 shadow-[0_24px_66px_rgba(0,0,0,0.46)]" style={{ '--frame-delay': '0ms' }}>
                <img src="/Kathirai-pattu/KP-PP-2.png" alt="Kaithirai Pattu main" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.92]" />
              </div>
            ...
            <div className="grid gap-4 lg:hidden">
              <div className="hero-box-image overflow-hidden rounded-lg border border-[#c9933a]/34 bg-[#0d0d1a] shadow-[0_26px_70px_rgba(0,0,0,0.42)]">
                <img src="/Kathirai-pattu/KP-PP-2.png" alt="Kaithirai Pattu" className="h-[440px] w-full object-cover object-top brightness-[0.88]" />
              </div>
              ...
              <div className="hero-box-info rounded-lg border border-[#c9933a]/28 bg-[#1b1930]/78 p-5 shadow-[0_14px_34px_rgba(0,0,0,0.22)] backdrop-blur-sm">
                <p className="font-sans text-[10px] font-semibold uppercase tracking-[2.4px] text-[#c9933a]">Kaithirai Notes</p>
                <ul className="mt-4 space-y-3">
                  {kaithiraiNotes.map((item, index) => (
        ...
        <div className="relative mx-auto max-w-[1480px]">
          <div className="mb-8 text-center">
            ...
            <h2 className="mt-3 font-serif text-[34px] font-normal leading-[1.12] text-[#1a1a2e] sm:text-[44px] lg:text-[50px]">
              Kaithirai <em className="italic text-[#c9933a]">Silk Designs</em>
            </h2>
              ...
              {kaithiraiDesigns.map((saree) => (
                <article key={saree.name} className="kaithirai-design-card relative flex w-[82vw] max-w-[380px] flex-col overflow-hidden rounded-xl border border-[#e4cba8] bg-[#fffaf2] text-[#1a1a2e] shadow-[0_14px_34px_rgba(92,58,24,0.14)] transition-all duration-300 hover:-translate-y-1 hover:border-[#c9933a]/70 hover:shadow-[0_24px_52px_rgba(92,58,24,0.20)] sm:w-[300px] lg:w-[330px] xl:w-[350px]">
                  ...
                  <a href={saree.href} className="block h-[230px] shrink-0 overflow-hidden bg-[#e8ddcf] sm:h-[250px] lg:h-[270px]" aria-label={`Open ${saree.name} designs`}>
                    <img src={saree.img} alt={saree.name} className="kaithirai-design-image h-full w-full object-cover object-top transition-transform duration-500" />
                  </a>
                  <div className="kaithirai-design-body flex flex-1 flex-col rounded-t-lg bg-[#fffaf2] px-5 pb-6 pt-6 text-center shadow-[0_-10px_22px_rgba(74,45,18,0.08)]">
                    <h3 className="kaithirai-design-title font-sans text-[19px] font-extrabold leading-tight text-[#241b27]">{saree.name}</h3>
                    <p className="kaithirai-design-desc mx-auto mt-3 min-h-[48px] max-w-[290px] font-sans text-[15px] font-semibold leading-[1.5] text-[#4a3f49]">{saree.desc}</p>
