const kaithiraiDesigns = [
  { name: 'Poigai Pattu', slug: 'poigai-pattu', href: '/kaithirai-pattu/poigai-pattu', desc: 'Water lily motif woven silk for elegant occasions', img: '/w2.png', badge: 'Popular', badgeIcon: 'fa-star' },
  { name: 'Punnai Kodi', slug: 'punnai-kodi', href: '/kaithirai-pattu/punnai-kodi', desc: 'Bay leaf vine patterned silk loved across Salem', img: '/3-pose3.png' },
  { name: 'Thennai Pattu', slug: 'thennai-pattu', href: '/kaithirai-pattu/thennai-pattu', desc: 'Palm weave festive silk with majestic natural beauty', img: '/sec-pose5.png', badge: 'New', badgeIcon: 'fa-sparkles' },
]
          ...
          <div className="relative">
            <div className="hidden h-[620px] translate-x-[20px] grid-cols-12 grid-rows-10 gap-3 lg:grid xl:h-[700px]">
              <div className="hero-box-image hero-frame-gold col-start-1 col-end-4 row-start-3 row-end-6 overflow-hidden rounded-sm bg-[#eadfce] p-1.5 shadow-[0_18px_42px_rgba(0,0,0,0.36)]" style={{ '--frame-delay': '80ms' }}>
                <img src="/w3.png" alt="Kaithirai Pattu silk" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.9]" />
              </div>
              <div className="hero-box-image hero-frame-gold col-start-4 col-end-9 row-start-1 row-end-5 overflow-hidden rounded-sm bg-[#eadfce] p-2 shadow-[0_24px_66px_rgba(0,0,0,0.46)]" style={{ '--frame-delay': '0ms' }}>
                <img src="/w2.png" alt="Kaithirai Pattu main" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.92]" />
              </div>
              ...
              <div className="hero-box-image hero-frame-gold col-start-7 col-end-10 row-start-5 row-end-8 overflow-hidden rounded-sm bg-[#eadfce] p-1.5 shadow-[0_16px_38px_rgba(0,0,0,0.34)]" style={{ '--frame-delay': '320ms' }}>
                <img src="/w4.png" alt="Kaithirai Pattu classic" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.9]" />
              </div>
            </div>
            <div className="grid gap-4 lg:hidden">
              <div className="hero-box-image overflow-hidden rounded-lg border border-[#c9933a]/34 bg-[#0d0d1a] shadow-[0_26px_70px_rgba(0,0,0,0.42)]">
                <img src="/w2.png" alt="Kaithirai Pattu" className="h-[440px] w-full object-cover object-top brightness-[0.88]" />
              </div>
