const sailaDesigns = [
  { name: 'Suvarneela', slug: 'malar-kodi', href: '/saila-pattu/malar-kodi', desc: 'Vine motif silk with graceful festive texture', img: '/Saila-Pattu/SP-Blue-2.png', badge: 'Bestseller', badgeIcon: 'fa-crown' },
]
          ...
          <div className="relative">
            <div className="hidden h-[620px] translate-x-[20px] grid-cols-12 grid-rows-10 gap-3 lg:grid xl:h-[700px]">
              <div className="hero-box-image hero-frame-gold col-start-1 col-end-4 row-start-3 row-end-6 overflow-hidden rounded-sm bg-[#eadfce] p-1.5 shadow-[0_18px_42px_rgba(0,0,0,0.36)]" style={{ '--frame-delay': '80ms' }}>
                <img src="/Kathirai-pattu/KP-PP-1.png" alt="Saila Pattu green silk detail" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.9]" />
              </div>
            ...
            <div className="grid gap-4 lg:hidden">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="overflow-hidden rounded-lg border border-[#c9933a]/24 bg-[#0d0d1a]">
                  <img src="/Kathirai-pattu/KP-PP-1.png" alt="Saila Pattu green silk" className="h-[180px] w-full object-cover object-top brightness-[0.84]" />
                </div>
                <div className="overflow-hidden rounded-lg border border-[#c9933a]/24 bg-[#0d0d1a]">
