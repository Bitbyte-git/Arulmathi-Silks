const sailaDesigns = [
  { name: 'Suvarneela', slug: 'malar-kodi', href: '/saila-pattu/malar-kodi', desc: 'Vine motif silk with graceful festive texture', img: '/saila-pattu/SP-SN-0101-3.png', badge: 'Bestseller', badgeIcon: 'fa-crown' },
]
