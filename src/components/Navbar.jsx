...
const megaCollections = [
  { number: '01', title: 'இழமதி பட்டு', count: 'DESIGNS', icon: 'fa-landmark', href: '/izhamathi-pattu' },
  { number: '02', title: 'சைலா பட்டு', count: 'DESIGNS', icon: 'fa-seedling', href: '/saila-pattu' },
  { number: '03', title: 'ஆஞ்சலி பட்டு', count: 'DESIGNS', icon: 'fa-clover', href: '/Aanchali-pattu' },
  { number: '04', title: 'மயூரா பட்டு', count: 'DESIGNS', icon: 'fa-fan', href: '/mayura-pattu' },
  { number: '05', title: 'வைபவ பட்டு', count: 'DESIGNS', icon: 'fa-border-all', href: '/vaibhava-pattu' },
  { number: '06', title: 'நூலிசை பட்டு', count: 'DESIGNS', icon: 'fa-feather-pointed', href: '/noolisa i-pattu' },
  { number: '07', title: 'செழிநூல் பட்டு', count: 'DESIGNS', icon: 'fa-gem', href: '/sezhinool-pattu' },
  { number: '08', title: 'வெலோரா பட்டு', count: 'DESIGNS', icon: 'fa-spa', href: '/velora-pattu' },
  { number: '09', title: 'எழில் பட்டு', count: 'DESIGNS', icon: 'fa-star', href: '/ezhil-pattu' },
  { number: '10', title: 'கைத்திரை பட்டு', count: 'DESIGNS', icon: 'fa-briefcase', href: '/kaithirai-pattu' },
  { number: '11', title: 'வர்ணிகா பட்டு', count: 'DESIGN', icon: 'fa-sun', href: '/varnika-pattu' },
  { number: '12', title: 'மங்கை பட்டு', count: 'DESIGNS', icon: 'fa-fire-flame-curved', href: '/mangai-pattu' },
]
const shoppingSteps = [
