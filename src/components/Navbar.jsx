...
const megaCollections = [
  ...
  { number: '06', title: 'நூலிசை பட்டு', count: 'DESIGNS', icon: 'fa-feather-pointed', href: '/noolisai-pattu' },
  { number: '07', title: 'சென்னூல் பட்டு ', count: 'DESIGNS', icon: 'fa-gem', href: '/sezhinool-pattu' },
