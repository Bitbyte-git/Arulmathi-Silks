const noolisaiDesigns = [
  { name: 'Nool Veli', slug: 'nool-veli', href: '/noolisai-pattu/nool-veli', desc: 'Fine thread border woven silk', img: '/w2.png', badge: 'Gifting', badgeIcon: 'fa-gift' },
  { name: 'Mella Pattu', slug: 'mella-pattu', href: '/noolisai-pattu/mella-pattu', desc: 'Soft lightweight loom silk for everyday grace', img: '/image11.png' },
  { name: 'Pon Nool', slug: 'pon-nool', href: '/noolisai-pattu/pon-nool', desc: 'Golden thread woven texture with warm shimmer', img: '/w5.png', badge: 'New', badgeIcon: 'fa-sparkles' },
]

const noolisaiNotes = [
  'Fine thread and loom weaving for soft, lightweight silk drapes',
  'Delicate gold thread borders and subtle shimmer for everyday elegance',
  'Curated for gifting, pooja, and refined festive wear',
]
        ...
        <div className="relative mx-auto grid max-w-[1540px] grid-cols-1 gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:items-center lg:gap-12 xl:gap-16">
          <div className="max-w-[560px] lg:pb-6">
            ...
            <h1 className="mt-4 font-serif text-[52px] font-normal leading-[0.98] text-white sm:text-[78px] lg:text-[92px] xl:text-[104px]">
              Noolisai<br /><em className="italic text-[#d4a853]">Pattu</em>
            </h1>
            <p className="mt-6 max-w-[520px] font-sans text-[13px] leading-[1.95] text-white/76 sm:text-[14px]">
              Fine thread woven silks with delicate loom work, soft colors, and everyday elegance for gifting and refined festive wear.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <a href="/#shop" className="glow-cta inline-flex items-center gap-3 border border-[#c9933a]/80 px-5 py-3 font-sans text-[11px] font-semibold uppercase tracking-[1.9px] text-[#d9a046] transition-colors hover:bg-[#c9933a] hover:text-[#13121f]">Shop Noolisai Pattu <i className="fas fa-arrow-right" /></a>
          ...
          <div className="relative">
            <div className="hidden h-[620px] translate-x-[20px] grid-cols-12 grid-rows-10 gap-3 lg:grid xl:h-[700px]">
              <div className="hero-box-image hero-frame-gold col-start-1 col-end-4 row-start-3 row-end-6 overflow-hidden rounded-sm bg-[#eadfce] p-1.5 shadow-[0_18px_42px_rgba(0,0,0,0.36)]" style={{ '--frame-delay': '80ms' }}><img src="/w3.png" alt="Noolisai thread silk" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.9]" /></div>
              <div className="hero-box-image hero-frame-gold col-start-4 col-end-9 row-start-1 row-end-5 overflow-hidden rounded-sm bg-[#eadfce] p-2 shadow-[0_24px_66px_rgba(0,0,0,0.46)]" style={{ '--frame-delay': '0ms' }}><img src="/w2.png" alt="Noolisai nool veli" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.92]" /></div>
              <div className="hero-box-image hero-frame-gold col-start-9 col-end-12 row-start-1 row-end-3 overflow-hidden rounded-sm bg-[#eadfce] p-1.5 shadow-[0_16px_38px_rgba(0,0,0,0.34)]" style={{ '--frame-delay': '160ms' }}><img src="/image9.png" alt="Noolisai loom detail" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.9]" /></div>
              <div className="hero-box-image hero-frame-gold col-start-2 col-end-7 row-start-5 row-end-10 overflow-hidden rounded-sm bg-[#eadfce] p-2 shadow-[0_24px_62px_rgba(0,0,0,0.44)]" style={{ '--frame-delay': '240ms' }}><img src="/image11.png" alt="Noolisai mella pattu" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.9]" /></div>
              <div className="hero-box-image hero-frame-gold col-start-7 col-end-10 row-start-5 row-end-8 overflow-hidden rounded-sm bg-[#eadfce] p-1.5 shadow-[0_16px_38px_rgba(0,0,0,0.34)]" style={{ '--frame-delay': '320ms' }}><img src="/w5.png" alt="Noolisai pon nool" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.9]" /></div>
            </div>
            <div className="grid gap-4 lg:hidden">
              <div className="hero-box-image overflow-hidden rounded-lg border border-[#c9933a]/34 bg-[#0d0d1a] shadow-[0_26px_70px_rgba(0,0,0,0.42)]"><img src="/w2.png" alt="Noolisai Pattu silk" className="h-[440px] w-full object-cover object-top brightness-[0.88]" /></div>
              <div className="grid grid-cols-2 gap-4">
                <div className="overflow-hidden rounded-lg border border-[#c9933a]/24 bg-[#0d0d1a]"><img src="/image11.png" alt="Noolisai mella pattu" className="h-[180px] w-full object-cover object-top brightness-[0.84]" /></div>
                <div className="overflow-hidden rounded-lg border border-[#c9933a]/24 bg-[#0d0d1a]"><img src="/w5.png" alt="Noolisai pon nool" className="h-[180px] w-full object-cover object-top brightness-[0.88]" /></div>
              </div>
              <div className="hero-box-info rounded-lg border border-[#c9933a]/28 bg-[#1b1930]/78 p-5 shadow-[0_14px_34px_rgba(0,0,0,0.22)] backdrop-blur-sm">
                <p className="font-sans text-[10px] font-semibold uppercase tracking-[2.4px] text-[#c9933a]">Noolisai Notes</p>
                <ul className="mt-4 space-y-3">
                  {noolisaiNotes.map((item, index) => (
      ...
      <div className="relative bg-[#f5f0e8] px-5 py-12 text-[#1a1420] sm:px-8 lg:px-16 lg:py-16">
        ...
        <div className="relative mx-auto max-w-[1480px]">
          <div className="mb-8 text-center">
            ...
            <h2 className="mt-3 font-serif text-[34px] font-normal leading-[1.12] text-[#1a1a2e] sm:text-[44px] lg:text-[50px]">Noolisai <em className="italic text-[#c9933a]">Silk Designs</em></h2>
