const noolisaiDesigns = [
  ...
  { name: 'அணிமாலை பட்டு', slug: 'animaalai-pattu', href: '/noolisai-pattu/animaalai-pattu', desc: 'Ornamental garland motifs woven into rich festive silk', img: '/noolisai-pattu/aanimaalai-pattu/NL-AM-0101-1.png', badge: 'New', badgeIcon: 'fa-gem' },
  { name: 'பொதும்பு பட்டு', slug: 'pothumbu-pattu', href: '/noolisai-pattu/pothumbu-pattu', desc: 'Lush nature-inspired weaving with elegant zari detail', img: '/noolisai-pattu/podhumbu-pattu/NL-PT-0101-3.png', badge: 'New', badgeIcon: 'fa-leaf' },
]

const noolisaiNotes = [
  'Deep magenta pure handloom silk with woven self-pattern jaal motifs',
  'Bold royal blue contrast border with large antique gold diamond chakra buttas',
  'Curated for weddings, receptions, poojas, and grand festive celebrations',
]
        ...
        <div className="relative mx-auto grid max-w-[1540px] grid-cols-1 gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:items-center lg:gap-12 xl:gap-16">
          <div className="max-w-[560px] lg:pb-6">
            ...
            <h1 className="collection-hero-tamil-name mt-4 font-serif text-[52px] font-normal leading-[0.98] text-white sm:text-[78px] lg:text-[92px] xl:text-[104px]">
              நூலிசை<br /><em className="italic text-[#d4a853]">பட்டு</em>
            </h1>
            <p className="mt-6 max-w-[520px] font-sans text-[13px] leading-[1.95] text-white/76 sm:text-[14px]">
              Rich magenta handloom silk with bold royal blue contrast border bearing large antique gold diamond butta motifs — crafted for weddings, receptions, and grand festive celebrations.
            </p>
          ...
          <div className="relative">
            <div className="hidden h-[620px] translate-x-[20px] grid-cols-12 grid-rows-10 gap-3 lg:grid xl:h-[700px]">
              <div className="hero-box-image hero-frame-gold col-start-1 col-end-4 row-start-3 row-end-6 overflow-hidden rounded-sm bg-[#eadfce] p-1.5 shadow-[0_18px_42px_rgba(0,0,0,0.36)]" style={{ '--frame-delay': '80ms' }}><img src="/noolisai-pattu/NL-NK-0101-2.png" alt="Nool Kodi thread silk" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.9]" /></div>
              <div className="hero-box-image hero-frame-gold col-start-4 col-end-9 row-start-1 row-end-5 overflow-hidden rounded-sm bg-[#eadfce] p-2 shadow-[0_24px_66px_rgba(0,0,0,0.46)]" style={{ '--frame-delay': '0ms' }}><img src="/noolisai-pattu/NL-NK-0101-3.png" alt="Noolisai Nool Kodi" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.92]" /></div>
              <div className="hero-box-image hero-frame-gold col-start-9 col-end-12 row-start-1 row-end-3 overflow-hidden rounded-sm bg-[#eadfce] p-1.5 shadow-[0_16px_38px_rgba(0,0,0,0.34)]" style={{ '--frame-delay': '160ms' }}><img src="/noolisai-pattu/aanimaalai-pattu/NL-AM-0101-1.png" alt="Nool Kodi loom detail" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.9]" /></div>
              <div className="hero-box-image hero-frame-gold col-start-2 col-end-7 row-start-5 row-end-10 overflow-hidden rounded-sm bg-[#eadfce] p-2 shadow-[0_24px_62px_rgba(0,0,0,0.44)]" style={{ '--frame-delay': '240ms' }}><img src="/noolisai-pattu/aanimaalai-pattu/NL-AM-0101-2.png" alt="Nool Kodi silk saree" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.9]" /></div>
              <div className="hero-box-image hero-frame-gold col-start-7 col-end-10 row-start-5 row-end-8 overflow-hidden rounded-sm bg-[#eadfce] p-1.5 shadow-[0_16px_38px_rgba(0,0,0,0.34)]" style={{ '--frame-delay': '320ms' }}><img src="/noolisai-pattu/podhumbu-pattu/NL-PT-0101-4.png" alt="Nool Kodi fine border detail" className="h-full w-full rounded-[2px] object-cover object-top brightness-[0.9]" /></div>
            </div>
            <div className="grid gap-4 lg:hidden">
              <div className="hero-box-image overflow-hidden rounded-lg border border-[#c9933a]/34 bg-[#0d0d1a] shadow-[0_26px_70px_rgba(0,0,0,0.42)]"><img src="/noolisai-pattu/NL-NK-0101-2.png" alt="Noolisai Pattu silk" className="h-[440px] w-full object-cover object-top brightness-[0.88]" /></div>
              <div className="grid grid-cols-2 gap-4">
                <div className="overflow-hidden rounded-lg border border-[#c9933a]/24 bg-[#0d0d1a]"><img src="/noolisai-pattu/NL-NK-0101-3.png" alt="Nool Kodi fine thread border" className="h-[180px] w-full object-cover object-top brightness-[0.84]" /></div>
                <div className="overflow-hidden rounded-lg border border-[#c9933a]/24 bg-[#0d0d1a]"><img src="/noolisai-pattu/aanimaalai-pattu/NL-AM-0101-1.png" alt="Nool Kodi saree fold" className="h-[180px] w-full object-cover object-top brightness-[0.88]" /></div>
              </div>
      ...
      <div className="relative bg-[#f5f0e8] px-5 py-12 text-[#1a1420] sm:px-8 lg:px-16 lg:py-16">
        ...
        <div className="relative mx-auto max-w-[1480px]">
          <div className="mb-8 text-center">
            ...
            <h2 className="mt-3 font-serif text-[34px] font-normal leading-[1.12] text-[#1a1a2e] sm:text-[44px] lg:text-[50px]"><span className="section-heading-tamil-name">நூலிசை</span> <em className="italic text-[#c9933a]">Silk Designs</em></h2>
