...
export default function KaithiraiDesignDetail({ collectionSlug, designSlug }) {
  const collection = getKaithiraiPattuCollection(collectionSlug)
  const design = getKaithiraiPattuDesign(collectionSlug, designSlug)
    ...
    <section className="bg-[#080711] text-white">
      <div className="relative isolate overflow-hidden px-5 pb-12 pt-10 sm:px-8 lg:px-16">
        ...
        <div className="mx-auto max-w-7xl">
          <a href={`/kaithirai-pattu/${collection.slug}`} className="inline-flex border-b border-[#c9933a] pb-1 font-sans text-[10px] font-bold uppercase tracking-[2.5px] text-[#c9933a] transition-colors hover:text-[#f0c36e]">
