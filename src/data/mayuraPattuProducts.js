export const mayuraPattuCollections = [
  {
    ...
    heroImage: '/Mayura-pattu/MP-VM-2.png',
    heroImages: ['/Mayura-pattu/MP-VM-6.png', '/Mayura-pattu/MP-VM-5.png'],
    designs: [
      {
        ...
        code: 'MY-VM-0101',
        image: '/Mayura-pattu/MP-VM-1.png',
        images: [
          '/Mayura-pattu/MP-VM-1.png',
          '/Mayura-pattu/MP-VM-2.png',
          '/Mayura-pattu/MP-VM-3.png',
          '/Mayura-pattu/MP-VM-4.png',
          '/Mayura-pattu/MP-VM-5.png',
          '/Mayura-pattu/MP-VM-6.png',
        ],
        price: 'Rs. 22,400',
        oldPrice: 'Rs. 31,200',
        discount: '28% off',
