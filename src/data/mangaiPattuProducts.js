export const mangaiPattuCollections = [
  ...
  },
  {
    ...
    heroImage: '/mangai-pattu/MP-AP-4.png',
    heroImages: ['/mangai-pattu/MP-AP-4.png', '/mangai-pattu/MP-AP-3.png', '/mangai-pattu/MP-AP-5.png'],
    designs: [
      { slug: 'peacock-thogai-silk', name: 'Peacock Thogai Silk', code: 'MG-TG-0201', image: '/mangai-pattu/MP-AP-4.png', images: ['/mangai-pattu/MP-AP-4.png', '/mangai-pattu/MP-AP-3.png', '/mangai-pattu/MP-AP-5.png'], price: 'Rs. 17,800', oldPrice: 'Rs. 24,700', discount: '28% off', stock: 'In stock', color: 'Peacock Green', colors: ['Peacock Green', 'Teal Blue', 'Antique Gold'], fabric: 'Soft pure silk with peacock-plume inspired woven motifs', zari: 'Antique gold feather zari border and coordinated pallu', occasion: 'Engagement, reception, pooja, family celebrations', blouse: 'Peacock-green silk blouse with gold zari edging', details: 'Peacock Thogai Silk combines graceful plume-inspired motifs with peacock green silk and antique-gold zari.' },
      { slug: 'royal-blue-thogai-silk', name: 'Royal Blue Thogai Silk', code: 'MG-TG-0202', image: '/Images/sec-pose3.png', images: ['/Images/sec-pose3.png', '/Images/sec-pose2.png', '/Images/sec-pose5.png'], price: 'Rs. 18,400', oldPrice: 'Rs. 25,600', discount: '28% off', stock: 'In stock', color: 'Royal Blue', colors: ['Royal Blue', 'Peacock Blue', 'Gold'], fabric: 'Pure silk with delicate plume-pattern weaving', zari: 'Gold peacock-plume zari border with a rich festive pallu', occasion: 'Wedding, reception, festive gifting', blouse: 'Royal-blue silk blouse with gold feather border', details: 'Royal Blue Thogai Silk presents elegant plume motifs on a luminous blue body with a rich gold zari finish.' },
    ],
  },
]
