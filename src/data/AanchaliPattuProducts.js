export const AanchaliPattuCollections = [
  {
    ...
    heroImage: '/Ananchail-Pattu/SP-Green-1.png',
    designs: [
      {
        ...
        code: 'AP-KP-0101',
        image: '/Ananchail-Pattu/SP-Green-1.png',
        images: [
          '/Ananchail-Pattu/SP-Green-1.png',
          '/Ananchail-Pattu/SP-Green-2.png',
          '/Ananchail-Pattu/SP-Green-3.png',
          '/Ananchail-Pattu/SP-Green-4.png',
          '/Ananchail-Pattu/SP-Green-5.png',
        ],
        price: 'Rs. 17,500',
        oldPrice: 'Rs. 24,500',
        discount: '29% off',
